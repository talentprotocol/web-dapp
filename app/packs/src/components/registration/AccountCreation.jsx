...
const AccountCreation = ({ username, changeUsername, changeStep }) => {
  ...
  return (
    <div className="d-flex flex-column" style={{ maxWidth: 400 }}>
      ...
      <h1>Username</h1>
      <p>Choose the username that you want to represent you, it can be your name or something else if you wish to remain anonymous in the platform.</p>
      <form onSubmit={submitAccountCreationForm} className="d-flex flex-column">
        <div className="form-group">
          <label htmlFor="inputUsername"><small>Username</small></label>
          <input type="text"
        ...
        <div className="align-self-end">
          <button type="submit" disabled={!!username} className="ml-2 btn btn-primary talent-button">Next {">"}</button>
        </div>
      </form>
    </div>
  )
