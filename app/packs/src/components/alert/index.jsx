...
const Alert = (props) => {
  ...
  const children = props.children ? props.children : <AlertContent text={text} href={href} type={type} buttonText={buttonText}/>

  return (
    <div className={`alert talent-alert d-flex flex-column flex-sm-${flexDirection} align-items-center justify-content-between ${typeStyles}`} role="alert">
      {children}
    </div>
  )
}
